...
### Step 1
- Start your research by running the `/conditional_docs` command to determine what documentation to read.

## Relevant Files

Focus on the following files:
- `README.md` - Contains the project overview and instructions.
- `src/app/**` - Contains the codebase app files.
- `src/components/**` - Contains the codebase client components.
- `src/lib/**` - Contains the codebase library files.
- `src/types/**` - Contains the codebase types.
- `src/utils/**` - Contains the codebase utility files.
